const skills = [
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a101.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a102.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a103.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a104.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a105.png'],
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a201.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a202.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a203.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a204.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a205.png',
    'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a206.png'
  ],
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a207.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a208.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a209.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a210.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a211.png',
    'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a212.png'
  ],
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a301.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a302.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a303.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a304.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a305.png',
    'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a306.png'
  ],
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a307.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a308.png'],
  ['cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a401.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a402.png', 'cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_a403.png']
]
...
Page({
  ...
  selectImage: function (e) {
    ...
    let match = url.match(/_([a-z0-9]+)\./i);
    let skill = match ? match[1] : null;
    const that = this
    wx.showModal({
      title: 'warning',
      content: '你确定要给' + heroes_translation[GEMTD_HERO_LIST[hero]] + '购买' + GEMTD_HERO_LIST[skill] + '技能吗？',
      cancelColor: "#606c38",
      success: function (res) {
        let personid = that.data.person.id
        const randomNumber = getRandomInt(1, 10000);
        let posturl = `http://gemtd.ppbizon.com/gemtd/201803/ability/buy/${skill}@${hero}@${personid}?hehe=@${randomNumber}`;
        console.log(posturl)
      }
    })
  },
  ...
  setOnDutyHero_buy: function (hero) {
    console.log(hero)
    const that = this;
    return new Promise((resolve, reject) => {
      const randomNumber = getRandomInt(1, 10000);
      const url = `http://gemtd.ppbizon.com/gemtd/hero/save/${hero}@${that.data.person.id}?hehe=${randomNumber}`;
      wx.cloud.callFunction({
        ...
        success: res => {
          ...
          const randomNumber2 = getRandomInt(1, 10000); // 使用不同的变量名以避免混淆  
          const url2 = `http://gemtd.ppbizon.com/gemtd/202203/heros/get/@${that.data.person.id}?hehe=${randomNumber2}`;
          wx.cloud.callFunction({
            name: 'requestGEM',
            data: {
              url: url2
            ...
            success: res2 => {
              wx.hideLoading();
              resolve("更换成功"); // 在成功时解析 Promise  
            },
            fail: res2 => {
              wx.showToast({
                title: '更换失败',
              });
              reject("更换失败"); // 在失败时拒绝 Promise  
            }
          });
        },
        fail: err => {
          reject("初始请求失败"); // 初始请求失败时拒绝 Promise  
        }
      });
    });
  },
  ...
  onShow: function () {
    ...
    if (gemInfo) {
      ...
      if (gemInfo.rank_info.coop_level != 0) {
  ...
  getHero: function (onduty, gemInfo) {
    ...
    Object.keys(gemInfo.ability).forEach((key) => {
      var skill = {
        "ability": "cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/gem_" + key + ".png",
        "skillevel": level[gemInfo.ability[key]],
        "tag": false,
        "hero_id": gemInfo.hero_id
      }
      ability.push(skill)
    });
    ...
    for (let i = 1; i <= hero_length - length; i++) {
      var skill = {
        "ability": "cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/lottery/empty.PNG",
        "skillevel": level['0'],
        "tag": true,
        "hero_id": gemInfo.hero_id
      }
    ...
    if (hero_length < 4) {
      for (let i = 1; i <= 4 - hero_length; i++) {
        var skill = {
          "ability": "cloud://rebecca-2gbizwon5538bd4f.7265-rebecca-2gbizwon5538bd4f-1306855380/towers/award_item_extend.png",
          "skillevel": level['5'],
          "tag": false,
          "hero_id": gemInfo.hero_id
        }
